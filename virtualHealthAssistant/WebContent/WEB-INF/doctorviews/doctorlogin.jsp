...
<html lang="en">
    <head>
        <title>Vmedico doctor login</title>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p>Are you new here?</p><a href="http://localhost:8091/virtualHealthAssistant/dregister" class="mb-2 bread">Register Here!</a>
          </div>
        </div>
      </div>
    </section>
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <div class="heading-section heading-section-white ftco-animate mb-5">
	          	<span class="subheading">Kindly login</span>
	            <h2 class="mb-4"></h2>
	          </div>
	          <form action="<%=request.getContextPath()%>/dlogin"  method="post" class="appointment-form ftco-animate">
		    				<div class="d-md-flex">
...
<article class="col2">
						<div class="pad1">
							<form id="RegForm" action="<%=request.getContextPath()%>/dlogin" method="post">
							 <div id="error" style="display:block;"><font color="red">
									...
									<div  class="wrapper">
										...
										<div class="bg"><input type="text" class="input" name="username" placeholder="Enter username" ></div>
									</div>
                                                                    
                                                                        <div class="wrapper">
                                                                            <strong><b>Password:</b></strong>
                                                                            <div class="bg"><input type="password" class="input" name="password" placeholder="Enter password"></div>
                                                                        </div>       
