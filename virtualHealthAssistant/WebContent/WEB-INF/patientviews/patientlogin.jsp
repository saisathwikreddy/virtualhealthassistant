...
<html lang="en">
    <head>
        <title>Vmedico patient login</title>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p>Are you new here?</p><a href="http://localhost:8091/virtualHealthAssistant/pregister" class="mb-2 bread">Register Here!</a>
          </div>
        </div>
      </div>
    </section>
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter" style="background-image: url(images/bg_3.jpg);" data-stellar-background-ratio="0.5">
    	<div class="container">
    		<div class="row">
	          ...
	          <form action="<%=request.getContextPath()%>/plogin"  method="post" class="appointment-form ftco-animate">
		    				<div class="d-md-flex">
