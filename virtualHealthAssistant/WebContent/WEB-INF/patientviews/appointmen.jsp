    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="http://localhost:8091/virtualHealthAssistant/logout" class="btn btn-secondary py-2 px-3">logout</a></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item"><a href="patienthome.html" class="nav-link pl-0">Home</a></li>
      ...
      <div class="container">
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <form action="<%=request.getContextPath()%>/appointment" class="appointment-form ftco-animate" method="post">
	    				<div class="d-md-flex">
